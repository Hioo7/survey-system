...
export default function Icon() {
  return new ImageResponse(
    (
      <div
        style={{
          background: 'linear-gradient(180deg, #2A1A12 0%, #3B2416 55%, #6F4A2D 100%)',
          width: '100%',
          height: '100%',
          borderRadius: 96,
          display: 'flex',
      ...
      >
        <div
          style={{
            ...
            justifyContent: 'center',
            position: 'relative',
            background: 'linear-gradient(180deg, #FFF8F1 0%, #F5EDE3 100%)',
            borderRadius: 72,
            boxShadow: '0 28px 60px rgba(42, 26, 18, 0.34)',
            border: '8px solid rgba(200, 155, 109, 0.92)',
          }}
        >
          <div
            style={{
              ...
              inset: 18,
              borderRadius: 54,
              background: 'linear-gradient(180deg, rgba(255, 248, 241, 0.92) 0%, rgba(231, 216, 201, 0.5) 100%)',
            }}
          />
          <svg
            viewBox="0 0 512 512"
            style={{
              ...
              fill: '#3B2416',
              position: 'relative',
              filter: 'drop-shadow(0 6px 18px rgba(42, 26, 18, 0.18))',
            }}
          >
            <path d={COFFEE_BEAN_PATH} />
          </svg>
        </div>
      </div>
    ),
